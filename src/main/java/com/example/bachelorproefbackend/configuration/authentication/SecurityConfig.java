...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(POST, "/timing").hasAnyAuthority(ADMIN, COORDINATOR);
        ...
        http.authorizeRequests().antMatchers(POST, "/userManagement/company/{companyId}/addContact").hasAnyAuthority(ADMIN, COORDINATOR, CONTACT);
